...
## dificuldades e expectativas 
 ...
 O protótipo foi desenvolvido em quanto a disciplina estava sendo cursada, porém não definitvamente desde o início, já que em sua primeira metade foi apresentado conceitos e noções de hardware como módulos e sistemas embarcados para capacitar o aluno a desenvolver algo. Como o CIA foi realizado em parceria com o curso de Arquitetura e urbanisno, que trouxe o  tema arborização o como a ideia central. Desde muito cedo, mesmo sem o conhecimento técnico ainda consolidado, houve vários encontros para discutir o que seria projetado e ideias de como isso poderia ser feito. Aqui entra uma das dificuldades que encontrei. Principalmente no início foi difícil alinhar o que se desejava com o que era possível realizar. Como eu fazia parte do pessoal que desenvolveria a parte eletrônica do dispositivo era de minha responsabilidade consegui passar que determinada ideia era inviável ou não. E na época eu tinha pouca noção. Acredito que falta de experiência me limitou a ser mais assertivo em propor ideias ou viabilizar ideias.

 Como eram dois grupos distintos trabalhando com o tema, a decisão final foi de alguma forma interligar em algum ponto ambos. Então o CIA seria o prótotipo móvel, e o {ok} como o fixo.  como o projeto foi exposto ao público em uma sala no CT12 do campus, houve a escolha de definir o percurso nas proximidades do local. Assim através da face de apoio, que foi utilziada como espaço para projetar o mapa de onde estariam localizadas as árvore que foram cadastradas no programa poderia se orientrar de maneira individual sobre o percurso. A imagem abaixo mostra o mapa fixado na face de apoio:

<div align="center">
   <img src="imagens/faceApoio.jpeg" alt="mapa face apoio" width="200px">
</div>

 Com certeza o maior desafio que enfrentei, foi fazer as conexões. Quando definitivamente as faces estavam em nossa posse, faltava menos de uma semana para entrega final, embora tudo estivesse alinhado no campo teórico em termos do que fazer. Acabei subestimando a dificuldade que teria ao alojar todos os equipamentos dentro do cubo com tantas conexões. Foi um imprevisto que causou muita dor de cabeça. Não consegui prever que isso seria um problema, e muito menos com a  dimensão que se teve. o espaço ficou muito na medida, era dificil fazer as conexões sem esbarrar em outras, ou mesmo chegar em determinados pontos internos. Então mesmo que todas as faces funcionassem de maneira individual, não era suficiente. Mesmo que todas as faces juntas funcionassem quando o cubo estivesse estático, não era o suficiente. A maior provação seria coloca-lo na mão de outra pessoa e tudo ainda assim funcionasse. E esse era o maior receio. Pela experiencia na montagem, não seria difícil com tanta movimentação algumas conexão se desfazer. E a grande questão seria encontrar o erro naquele ambiente "turbulento" de fios se entrelassando. E seria inevitável ter que retirar uma das faces para que a manutenção fosse executada. Então tudo que eu pensava era: " Quais são os passos que devo executar?". No dia da apresentação. O percurso foi feito apenas uma vez, e eu acabei guiando um grupo de pessoas, com o cubo em minha posse. Meus movimentos eram comedidos, conscientes, mas acredito que outra pessoa não teria feito nada diferente que pudesse provocar algum erro, já que os meus movimentos eram consideraveis. No decorrer da exposição, apresentamos em uma sala junto com os demais. E eu não abri uma vez se quer o cubo (emoji de duas mãos para o céu). Os únicos contratempos que surgiram, eu consegui fazer uma ótima intervenção. o primeiro quando o programa congelou na janela de busca, e peguei uma caneta e consegui acionar o botao de "reset" do arduino. E a outra foi quando um botão acabou soltando. E eu fiz uma gambiarra dificil de expressar em palavras. Mas em todo caso, o programa, as conexoes, a proposta. Tudo funcionou, e muito bem!
